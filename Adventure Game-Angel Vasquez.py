...
Your_office = Room("Your office", "This is your work office", Sword("Item: Sword"), None, "Weight_Room", "Clue_Room",
                   "Co_Worker_office", None)
Co_Worker_office = Room("Co-worker's office", "This is your co-worker's office", Taser("Item: Taser"), "Your_office",
                        "Break_Room2", "Break_Room", "Clue_Room2", None, None)
Clue_Room = Room("Clue room", "This a clue room (The clue is to go south 2 times.)", Shield("Item: Shield"), None,
                 "Your_office", None, "Break_Room", None, None)
Weight_Room = Room("Weight room", "This is where the workers workout", Boots("Item:Boots"), None, None, "Your_office",
                   "Break_Room", None, None)
Break_Room = Room("Break Room", "This is where the workers take breaks", Water("Item:Water"), "Clue_Room",
                  "Co_Worker_Office", None, "Training_Room", None, None)
Training_Room = Room("training room", "This is where workers do their training", Knife("Item:Knife"), None,
                     "Clue_Room2", None, None, None, None)
Clue_Room2 = Room("Another clue room", "This is a clue room (Go West)", Gun("Item:Gun"), "Co_Worker_office",
                  "Clue_Room3", "Training_Room", "Main_Office", None, None)
Clue_Room3 = Room("Third clue room", "This is a room (Go South)", Potion("Item:Potion"), "Break_Room2", None,
                  "Clue_Room2", "Clue_Room4", None, None)
Break_Room2 = Room("Another break room", "This is another room where the workers take brake", Clothes("Item:Clothes"),
                   "Weight_Room",  None, "Co_Worker_office", None, None, None)
Clue_Room4 = Room("Clue room", "Where a clue is at (Go South then go East)", Tomahawk("Item:Tomahawk"), "Clue_Room3",
                  None, "Main_Office", "Office", None, None)
Office = Room("A Office", "This is a random office", Laptop("Item:Laptop"), "Clue_Room4", None, "Main_Office", None,
              None, None)
Back_office = Room("Back office", "This is the back of the main office", Armor("Item:Armor"), None, "Main_Office", None,
                   "Parking_Lot", None, None)
Main_Office = Room("Main office", "This is the main office", Food("Item:Food"), "Clue_Room2", "Office", "Back_office",
                   "Front_Door", None, None)
Front_Door = Room("Front door", "This is the front door either for the entrance or the exit", Pills("Item:Pills"),
                  "Main_Office", None, "Parking_Lot", None, None, None)
Parking_Lot = Room("Parking lot", "This is where all the worker's cars are parked at", Helmet("Item:Helmet"),
                   "Back_office", "Front_Door", None, None, None, None)
